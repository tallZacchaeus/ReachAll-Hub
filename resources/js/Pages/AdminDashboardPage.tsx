        ...
        <Card className="bg-card shadow-sm border-2 border-border">
          ...
          <CardContent className="space-y-3">
            {pendingApprovals.map((item, index) => (
              <div
                key={index}
                className="flex items-center justify-between p-3 border-2 border-border rounded-lg hover:shadow-sm hover:border-[#1F6E4A] transition-all cursor-pointer"
              >
                <div className="flex items-center gap-3">
                  <div
          ...
          <CardContent>
            <div className="space-y-3">
              {topNominees.map((nominee, index) => (
                <div
                  key={index}
                  className="flex items-center gap-3 p-3 border-2 border-border rounded-lg hover:shadow-sm hover:border-[#1F6E4A] transition-all"
                >
            ...
            <div className="space-y-4">
              {recentActivity.map((activity) => (
                <div key={activity.id} className="flex items-start gap-3">
                  <div className={`w-2 h-2 rounded-full mt-2 ${activity.type === 'leave' ? 'bg-[#FFD400]' :
        ...
        <Card className="bg-card shadow-sm border-2 border-border">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 bg-[#f0fdf4] dark:bg-muted rounded-lg border-2 border-[#1F6E4A]">
