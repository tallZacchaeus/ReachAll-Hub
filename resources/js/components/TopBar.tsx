...
export function TopBar({
  ...
  const getNotificationColor = (type: string): string =>
    STATUS_COLORS[type as keyof typeof STATUS_COLORS] ?? STATUS_COLORS.info;

  return (
    <div className="h-16 bg-card border-b border-border flex items-center justify-between px-4 md:px-8 gap-3">
          ...
          <DialogContent className="max-w-lg p-0 overflow-hidden">
            ...
            <form onSubmit={handleSearchSubmit}>
              <div className="flex items-center gap-3 px-4 py-3 border-b border-border">
                ...
                />
                <kbd className="text-xs text-muted-foreground border border-border rounded px-1.5 py-0.5 shrink-0">
                  ESC
                </kbd>
              </div>
        ...
        <Popover>
          <PopoverTrigger asChild>
            ...
            >
              ...
              {unreadCount > 0 && (
                ...
                >
                  <span className="text-destructive-foreground text-xs">{unreadCount}</span>
                </motion.div>
              )}
            </Button>
          </PopoverTrigger>
          <PopoverContent className="w-96 p-0" align="end">
            <div className="p-4 border-b border-border">
              ...
              {unreadCount > 0 && (
                <Button
                  ...
                  className="text-brand hover:bg-muted p-0 h-auto"
                >
                  Mark all as read
                </Button>
              )}
                    ...
                    <motion.div
                      ...
                      className={`p-3 mb-2 rounded-lg cursor-pointer transition-colors ${
                        notification.read
                          ...
                          : "bg-brand-subtle dark:bg-muted hover:bg-green-50 dark:hover:bg-muted/80 border-l-4"
                      }`}
                      style={{
            ...
            <div className="p-3 border-t border-border">
              <Button
                variant="ghost"
                className="w-full text-brand hover:bg-muted"
        ...
        >
          ...
          <div className="text-left hidden md:block">
            <div className="flex items-center gap-2">
              ...
              {isTeamLead && (
                <Badge className="bg-brand-yellow text-brand-yellow-foreground hover:bg-brand-yellow h-5 px-1.5">
